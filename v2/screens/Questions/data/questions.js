const questions = [
	...
	{
		title:
			"If the patient is on an acid suppression medication, such as a proton pump inhibitor, the a higher pH is acceptable to confirm initial NG tube position in the stomach?",
		buttons: [
			["True", false],
			["False", true],
		],
